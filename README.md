...
FoodlyPro is a modern food ordering and delivery mobile application built with Flutter.
The app provides a complete food-ordering experience, allowing users to browse meals, customize their orders, manage their cart, and place orders through an intuitive and responsive interface.
...
Responsible for displaying the UI and interacting with the user.

ViewModel

Responsible for presentation logic and coordinating between the UI and application data.
...
"FoodlyPro Home" (screenshots/home.png)
...
git clone https://github.com/YOUR_USERNAME/foodlypro.git
